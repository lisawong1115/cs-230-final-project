...
public class HelpPanel extends JPanel {
  ...
  public HelpPanel(JPanel parent){
    ...
    // A panel that contains a Home button that guides user back to the home screen
    ...
    // A JTextPane that contains textual instructions, written in html style
    text = new JTextPane();
    ...
    text.setText("<html><body bgcolor=\"#eeeeee\"><div align=\"center\"><h1>Instructions</h1></div>" +
      ...
      "At the start of the game, you have as many seconds as you want to memorize the location of all the pairs. Then click " +
      "<b>Start</b>, and the pictures will turn around. When you click on two pictures, they must form a pair to stay " +
      "faced up. Otherwise, the pictures " +
      "turn around again. <br><br> Your total attempts and valid attempts (those find pairs) are tracked. When all the " +
      "pairs are found, you win the game!<br><br>If you want to play another game within the same level of difficulty, " +
      "simply press <b>Restart</b>. The <b>Home</b> button will guide you back to the home screen. Also, please feel " +
      "free to restart the game or go back to the home screen in the middle of a game " + 
